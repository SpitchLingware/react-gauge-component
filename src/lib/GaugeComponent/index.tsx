...
*/
export const GaugeComponent = (props: Partial<GaugeComponentProps>) => {
    ...
    const shouldInitChart = () => {
        ...
        let pointerPropsChanged =
            JSON.stringify(prevProps.current.pointer) !== JSON.stringify(mergedProps.current.pointer);
